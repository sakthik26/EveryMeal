...
export default class SubscriptionDetails extends React.Component {
  ...
  componentWillMount() {
    ...
    var promise = new Promise((resolve, reject) => {
      MealPlanService.getMealPlanInfo(this.props.match.params.id)
        .then(data => {
          this.setState({
            data: [...data],
            loading: false
        ...
        >
          ...
          <Grid item xs={8} sm={5}>
                ...
                <Card>
                  <CardContent className="card-content">
                    ...
                    <Typography color="textSecondary">
                      ...
                      {this.state.data[0].startingprice * 30}/month)
                    </Typography>
                  </CardContent>
                  <CardActions>
                ...
                <Card>
                  <CardContent className="card-content">
                    ...
                    <Typography color="textSecondary">
                      ...
                      {this.state.data[0].startingprice + 3 * 7}/week)
                    </Typography>
                  </CardContent>
                  <CardActions>
                    {/* <Button size="small">Learn More</Button> */}
            ...
            <Button
              ...
              color="secondary"
              onClick={() =>
                this.props.history.push("/checkout/" + this.state.data[0]._id, {
                  subscription: this.state.selectedValue
                })
              }
            >
              Subscribe
